                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-1.png" alt="product">
                                </div>
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-2.png" alt="product">
                                </div>
                                <h3 class="product-title">
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-3.png" alt="product">
                                </div>
                                <h3 class="product-title">
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-4.png" alt="product">
                                </div>
                                <h3 class="product-title">
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <a href="#new" class="product-tag">new</a>
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-5.png" alt="product">
                                </div>
                                <h3 class="product-title">
                                    <a href="shop-details.html">golden line</a>
                                </h3>
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-6.png" alt="product">
                                </div>
                                <h3 class="product-title">
                                    <a href="shop-details.html">Round Dial semi</a>
                                </h3>
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-7.png" alt="product">
                                </div>
                                <h3 class="product-title">
                                    <a href="shop-details.html">Black Dial Red</a>
                                </h3>
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-8.png" alt="product">
                                </div>
                                <h3 class="product-title">
                                    <a href="shop-details.html">Round Dial semi</a>
                                </h3>
                  ...
                  <button class="product-cart" tabindex="0">add to cart</button>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="product-style2 version3">
                                ...
                                <div class="product-img">
                                    <img class="img" src="{{asset('/')}}website/assets/img/product5/p-s-1-9.png" alt="product">
                                </div>
                                <h3 class="product-title">
                                    <a href="shop-details.html">Black Dial Red</a>
                                </h3>
