    ...
    <div class="vs-menu-area text-center">
        ...
        <div class="vs-mobile-menu">
            <ul>
                ...
                <li class="menu-item-has-children">
                    <a href="{{route('product.sidebar')}}">watch</a>
                </li>
                <li>
                    ...
                    <ul class="mega-menu">
                        <li><a href="products-grid.html">Page List 1</a>
                            <ul>
                                ...
                                <li><a href="index-3.html">Home 3</a></li>
                                <li><a href="{{route('about')}}">About</a></li>
                                <li><a href="{{route('product.sidebar')}}">watch</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a href="#">Page List 3</a>
                            <ul>
                                ...
                                <li><a href="{{route('product.sidebar')}}">Shop Sidebar</a></li>
                                <li><a href="shop-details.html">Shop Details</a></li>
                                <li><a href="{{route('add-to-cart')}}">My Cart</a></li>
    ...
    <div class="container custom-container">
        <div class="row justify-content-between align-items-center">
            ...
            <div class="col-xl-3 col-md-auto col-auto">
                <div class="header-wc">
                    <a class="wc-link" href="{{route('add-to-cart')}}">Wishlist
                    ...
                    <a class="wc-link" href="{{route('add-to-cart')}}">bag 0
            ...
            <div class="container">
                <div class="row gy-4 justify-content-between">
                    <div class="col-lg-3">
                        ...
                        <a href="{{route('add-to-cart')}}"><img src="{{asset('/')}}website/assets/img/footer/payments.png" alt="payments"></a>
                    </div>
                    ...
                    <div class="col-lg-auto">
                        <div class="footer-widget">
                            ...
                            <div class="footer-menu2">
                                ...
                                <a href="{{route('add-to-cart')}}">Order Cart</a>
                                <a href="{{route('about')}}">Privacy Policy</a>
