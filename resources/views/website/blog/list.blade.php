    ...
    <div class="breadcumb-wrapper" data-bg-src="{{asset('/')}}website/assets/img/bg/breadcumb-bg-1.jpg">
        ...
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">our blog list</h1>
                ...
                <div class="col-lg-9">
                        ...
                        <div class="blog-body">
                            <div class="blog-img">
                                <a href="{{route('blog-details')}}">
                                    <img class="img" src="{{asset('/')}}website/assets/img/blog/blog-list-1-1.jpg" alt="blog">
                                </a>
                            </div>
                            <div class="blog-content">
                                ...
                                <p class="blog-text">
                                    Lorem ipsum dolor sit amet, conersse elit, sedid that eiusmod aboret dolore magna aliqua conseel
                                    usndi labois sitamet sedid eiusm
                                </p>
                    ...
                    <div class="vs-blog blog-style3">
                        <div class="blog-body">
                            <div class="blog-img">
                                <a href="{{route('blog-details')}}">
                                    <img class="img" src="{{asset('/')}}website/assets/img/blog/blog-list-1-2.jpg" alt="blog">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                    ...
                    <div class="vs-blog blog-style3">
                        <div class="blog-body">
                            <div class="blog-img">
                                <a href="{{route('blog-details')}}">
                                    <img class="img" src="{{asset('/')}}website/assets/img/blog/blog-list-1-3.jpg" alt="blog">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                    ...
                    <div class="vs-blog blog-style3">
                        <div class="blog-body">
                            <div class="blog-img">
                                <a href="{{route('blog-details')}}">
                                    <img class="img" src="{{asset('/')}}website/assets/img/blog/blog-list-1-4.jpg" alt="blog">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
                    ...
                    <div class="vs-blog blog-style3">
                        <div class="blog-body">
                            <div class="blog-img">
                                <a href="{{route('blog-details')}}">
                                    <img class="img" src="{{asset('/')}}website/assets/img/blog/blog-list-1-5.jpg" alt="blog">
                                </a>
                            </div>
                            <div class="blog-content">
                                <div class="blog-meta">
